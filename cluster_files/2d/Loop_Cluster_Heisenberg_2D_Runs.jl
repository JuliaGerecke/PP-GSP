...
"""
Run loop scaling benchmarks for 2D Heisenberg model on square lattice with OBC.
...
"""
function loop_heisenberg_2d_benchmarks(tile_width, scaled_lattice_width; use_initial_circuit=false)
...
for i in scaled_width
    loop_heisenberg_2d_benchmarks(2, i; use_initial_circuit=false)  # 2x2 → ixi (4 → i^2 qubits)
end
