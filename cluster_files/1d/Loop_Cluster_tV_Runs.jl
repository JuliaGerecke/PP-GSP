...
function loop_tV_benchmarks(tile_total_nq, scaled_total_nq; use_initial_circuit=false)
...
tile_total_nq = 2
loop_tV_benchmarks(tile_total_nq, 25)
# # ED regime
# for i in 4:15
#     loop_tV_benchmarks(tile_total_nq, i)
# end

#NQS regime
# nqubits = [20, 30, 35, 40, 45, 50]
# for i in nqubits
#     loop_tV_benchmarks(tile_total_nq, i)
# end
